...
var html_url_prefix = "/chain-solution";
var CONFIGURED_HTML_URL_PREFIX = "/chain-solution";
...
function get_html_url_prefix(){
    return '/chain-solution'  // this value is replaced by the actual url prefix when compiled
}
